...
(async () => {
  // Abre um navegador Chromium headless
  const browser = await puppeteer.launch();

  // Abre uma nova página
  const page = await browser.newPage();

  // Lista de URLs das páginas que você deseja visitar
  const lista = [
    ...
    'https://www.cia.gov/the-world-factbook/countries/central-african-republic/',
    ...
    'https://www.cia.gov/the-world-factbook/countries/comoros/',
    ...
    'https://www.cia.gov/the-world-factbook/countries/kiribati/',
    ...
    'https://www.cia.gov/the-world-factbook/countries/micronesia-federated-states-of/',
    ...
    'https://www.cia.gov/the-world-factbook/countries/sudan/',
  ...
  const a = {
    ...
    "saint vincent and the grenadines": {
        "nome_pt": "So Vicente e Granadinas",
    ...
    "so tomé and príncipe": {
        "nome_pt": "So Tomé e Príncipe",
        "nome_en": "So Tomé and Príncipe",
  ...
  for (const url of lista) {
    ...
    await page.goto(url);
    try{
    await page.waitForSelector("#economy", { timeout: 3000 });

    // Execute o comando em cada página e imprima o resultado
    const result = await page.evaluate(() => {
      const population = document.querySelector("#people-and-society").querySelector("div").querySelector("p").innerText;
      const gdp = document.querySelector("#economy").querySelectorAll("div")[4].querySelector("p").innerText;
      const area = document.querySelector("#geography").querySelectorAll("div")[3].querySelector("p").childNodes[1].data;
      const language = document.querySelector("#people-and-society > div:nth-child(5) > p").childNodes[0].data;
      const capital = document.querySelector("#government > div:nth-child(4) > p").childNodes[1].data;
    ...
    const pais = Object.keys(a)[z];
    console.log(`${(z/193)*100}%`)
    const dados = result;
    a[pais].pib =  dados.gdp;
    a[pais].area = dados.area;
    a[pais].populacao = dados.population;
    a[pais].idioma_en = dados.language;
    a[pais].capital_en = dados.capital;
  } catch (error){
  ...
  // Fecha o navegador
  await browser.close();
  fs.writeFileSync('ListaAutomatizada.json', JSON.stringify(a), 'utf-8')
