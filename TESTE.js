variavel = [
    {
        "nome_pt": "Afeganistão",
        "nome_en": "Afghanistan",
        "bandeira": "https://upload.wikimedia.org/wikipedia/commons/c/cd/Flag_of_Afghanistan_%282013%E2%80%932021%29.svg"
    },
    {
        "nome_pt": "Albânia",
        "nome_en": "Albania",
    ...
    },
    {
        ...
        "bandeira": "https://upload.wikimedia.org/wikipedia/commons/0/0a/Flag_of_S%C3%A3o_Tom%C3%A9_and_Pr%C3%ADncipe.svg"
    },
    {
    ...
    },
    {
        ...
        "bandeira": "https://upload.wikimedia.org/wikipedia/commons/a/a5/Flag_of_the_United_Kingdom_%281-2%29.svg"
    },
    {
...
for(let j = 0; j< variavel.length; j++){
    ...
    console.log(`'https://www.cia.gov/the-world-factbook/countries/${(variavel[j].nome_en).toLowerCase().replaceAll(" ", "-")}/',`)
    /*
    if((variavel[j].nome_en) != (variavel[j].nome_en).replace(" ", "_")){
     vetor.push(variavel[j].nome_en + ".html");
    }*/
}
