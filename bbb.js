...
Hard = ['france', 'brazil', 'germany', 'mexico', 'south korea', 'united states', 'saudi arabia', 'united kingdom', 'japan', 'canada'];
y=[];



for(n = 0; n< Hard.length; n++){
    for(z = 0; z < x.length; z++){7
    if((x[z].nome_en).toLowerCase() == Hard[n]){
        y.push(x[z])
    }
    }
}
...
console.log(Hard.length - y.length)
