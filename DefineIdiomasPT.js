...
const lista = {
    ...
    "antigua and barbuda": {
        ...
        "area": " 443km² (Antigua 280km²; Barbuda 161km²)",
        "pib": "$1.524 billion (2017 est.)",
        "idioma_en": "English",
        "idioma_pt": "Portugus",
        "moeda_pt": "Real Brasileiro",
        "moeda_en": "Brazilian Real",
    ...
    "chad": {
        ...
        "area": " 1.284 millionkm²",
        "pib": "$10.912 billion (2019 est.)",
    ...
    "cyprus": {
        ...
        "area": " 9,251km² (of which 3,355km² are in north Cyprus)",
        "pib": "$24.946 billion (2019 est.)",
    ...
    "niger": {
        ...
        "area": " 1.267 millionkm²",
        "pib": "$12.926 billion (2019 est.)",
        "idioma_en": "French",
        "idioma_pt": "Portugus",
        "moeda_pt": "Real Brasileiro",
        "moeda_en": "Brazilian Real",
    ...
    "saint kitts and nevis": {
        ...
        "area": " 261km² (Saint Kitts 168km²; Nevis 93km²)",
        "pib": "$964 million (2017 est.)",
        "idioma_en": "English",
        "idioma_pt": "Portugus",
        "moeda_pt": "Real Brasileiro",
        "moeda_en": "Brazilian Real",
    ...
    "saint vincent and the grenadines": {
        ...
        "area": " 389km² (Saint Vincent 344km²)",
        "pib": "$785 million (2017 est.)",
        "idioma_en": "English",
        "idioma_pt": "Portugus",
        "moeda_pt": "Real Brasileiro",
        "moeda_en": "Brazilian Real",
...
for (j = 0; j < Object.keys(lista).length; j++) {
    lista[Object.keys(lista)[j]].idioma_pt = lista[Object.keys(lista)[j]].idioma_en
}
for (j = 0; j < Object.keys(lista).length; j++) {
    lista[Object.keys(lista)[j]].idioma_pt = (lista[Object.keys(lista)[j]].idioma_pt).replace(/pashto/i, "Pastó").replace(/Albanian/i, 'Albanês').replace(/Arabic/i, "Arábe").replace(/French/i, "Francês").replace(/berber/i, "Berbere").replace(/catalan/i, "Catalão").replace(/portuguese/i,"Português").replace(/english/i, "Inglês").replace(/spanish/i, "Espanhol").replace(/Armenian/i, "Armênio").replace(/german/i, "Alemão").replace(/bangla/i, "Bengali").replace(/russian/i, "Russo").replace(/belarussian/i, "Bielorruso").replace(/dutch/i, "Neerlandês").replace(/dzongkha/i, 'Dzonga').replace(/QUECHUA/i, "Quéchua").replace(/Aymara/i, "Aimará").replace(/other indigenous languages/i, "outras línguas indígenas").replace(/bosnian/i, "Bósnio").replace(/serbian/i, "Sérvio").replace(/croatian/i, "Croata").replace(/malay/i, "Malaio").replace(/Bulgarian/i, "Búlgaro").replace(/sangho/i, "Sango").replace(/mandarin/i, "Mandarim").replace(/zhuang/i, "Xuém").replace(/yue/i, "Cantonês").replace(/mongolian/i, "Mongól").replace(/Uygur/i, "Uigur").replace(/Kyrgyz/i, "Quirguiz").replace(/tibetan/i, "Tibetano").replace(/Shikimoro/i, "Comoriano").replace(/greek/i, "Grego");
    lista[Object.keys(lista)[j]].idioma_pt = (lista[Object.keys(lista)[j]].idioma_pt).replace("Turkish", "Turco").replace("Czech", "Tcheco").replace("Danish", "Dinamarquês").replace("Tigrinya", "Tigrínia").replace("Estonian", "Estoniano").replace("siSwati", "suázi").replace("Amharic", "Amárico").replace("Tigrigna", "Tigrínia").replace("iTaukei", "iTaukei").replace("Fiji Hindi", "Híndi fijiano").replace("Finnish", "Finlandês").replace("Swedish", "Sueco").replace("Georgian", "Georgiano").replace("Abkhaz", "Abcázio").replace("21 Maya languages", "21 línguas maias").replace("Creole", "Crioulo").replace("Hungarian", "Hungáro").replace("Icelandic", "Islandês").replace("Hindi", "Híndi").replace("Bengali", "Bengali").replace("Marathi", "Marata").replace("Telugu", "Telugo").replace("Tamil", "Tâmil").replace("Gujarati", "Guzerate").replace("Urdu", "Urdu").replace("Kannada", "Canarim").replace("Odia", "Oriá").replace("Malayalam", "Malaiala").replace("Punjabi", "Panjabi").replace("Assamese", "Assamês").replace("Maithili", "Maithili").replace("others official languages", "outras línguas oficias").replace("Bahasa Indonesia", "Indonésio").replace("Persian Farsi", "Pérsio").replace("Kurdish", "Curdo").replace("Turkmen", "Turcomeno").replace("Syriac", "Siríaco").replace("Irish", "Irlandês").replace("Italian", "Italiano").replace("Japanese", "Japonês").replace("Kazakh", "Cazaque").replace("Kiswahili", "Suaíli").replace("Lao", "Laonio").replace("Latvian", "Letão").replace("Sesotho", "Sesoto").replace("Lithuanian", "Lituano").replace("Luxembourgish", "Luxemburguês").replace("Malagasy", "Malgaxe").replace("Bahasa Malaysia", "Malaio").replace("Dhivehi", "diveí")
    lista[Object.keys(lista)[j]].idioma_pt = (lista[Object.keys(lista)[j]].idioma_pt).replace("Maltese", "Maltês").replace("Marshallese", "Marshallesa").replace("Arabic (Hassaniya)", "Árabe hassani").replace("Pular", "Fula").replace("Soninke", "Soninquês").replace("Wolof", "Uolofe").replace("Romanian", "Romeno").replace("Montenegrin", "Montenegrino").replace("Burmese", "Burmês").replace("Nauruan", "nauruana").replace("Nepali", "Nepalês").replace("Korean", "Coreano").replace("Macedonian", "Macedônio").replace("Norwegian", "Norueguês").replace("Sindhi", "Sindis").replace("Saraiki", "Seraiki").replace("Balochi", "Balúchi").replace("Palauan", "Palauense").replace("Tagalog", "Tagalo").replace("Polish", "Polonês").replace("Mirandese", "Mirandês").replace("Kinyarwanda", "Quiniaruanda").replace("Swahili", "Suaíli").replace("Samoan", "Samoano").replace("Seychellois Creole", "Crioulo de Seicheles").replace("Temne", "Timenés").replace("Slovak", "Eslovaco").replace("Slovene", "Eslovênio").replace("isiZulu", "Zulu").replace("isiXhosa", "Xhosa").replace("Afrikaans", "Africâner").replace("Setswana", "Tswana").replace("Xitsonga", "Tsonga").replace("Tshivenda", "Venda").replace("isiNdebele", "Ndebele do norte").replace("Sinhala", "Cingalês").replace("Romansh", "Romanche").replace("Tajik", "Tajique").replace("Thai", "Tailandês").replace("Tongan", "Tonganês").replace("Tuvaluan", "Tuvaluano").replace("Ukrainian", "Ucrâniano").replace("Uzbek", "Uzbeque").replace("Bislama", "Bislamá").replace("Vietnamese", "Vietnamita").replace("Shona", "Xona").replace(" and ", " e ");
    lista[Object.keys(lista)[j]].capital_en =(lista[Object.keys(lista)[j]].capital_en).trim();
}
fs.writeFileSync("ListaIdiomaPT.json", JSON.stringify(lista), "utf8");